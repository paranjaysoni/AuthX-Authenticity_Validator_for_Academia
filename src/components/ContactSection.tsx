    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <button
            onClick={() => navigate('/')}
            className="group inline-flex items-center px-6 py-3 bg-white/80 backdrop-blur-sm text-gray-700 rounded-xl shadow-lg hover:shadow-xl border border-gray-200 hover:border-blue-300 transition-all duration-300 transform hover:-translate-x-1"
          >
            ...
            >
              ...
              <div className="flex justify-center space-x-3 mb-4">
                <a 
                  ...
                  className="group relative p-3 bg-gray-50 text-gray-600 rounded-xl hover:bg-blue-50 hover:text-blue-600 transition-all duration-300 transform hover:scale-110 hover:shadow-md"
                  title="Email"
                >
                ...
                {member.github && (
                  <a 
                    ...
                    className="group relative p-3 bg-gray-50 text-gray-600 rounded-xl hover:bg-gray-900 hover:text-white transition-all duration-300 transform hover:scale-110 hover:shadow-md"
                    title="GitHub"
                  >
                    <Github className="w-5 h-5" />
                    <div className="absolute inset-0 rounded-xl bg-gray-900 opacity-0 group-hover:opacity-5 transition-opacity duration-300" />
                  </a>
                )}
                {member.linkedin && (
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="group relative p-3 bg-gray-50 text-gray-600 rounded-xl hover:bg-blue-600 hover:text-white transition-all duration-300 transform hover:scale-110 hover:shadow-md"
                    title="LinkedIn"
                  >
              ...
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-transparent via-blue-50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            </div>
          ))}
        </div>
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a 
                  ...
                  className="group inline-flex items-center justify-center px-8 py-4 bg-white text-blue-600 rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
                >
                ...
                <a 
                  href="tel:8965875409" 
                  className="group inline-flex items-center justify-center px-8 py-4 bg-white/10 text-white border-2 border-white/30 rounded-xl font-semibold backdrop-blur-sm hover:bg-white/20 transform hover:scale-105 transition-all duration-300"
                >
        ...
        <div className="text-center">
          <div className="inline-flex items-center justify-center px-6 py-3 bg-white rounded-xl shadow-lg border border-gray-200 mb-4">
            <div className="flex items-center space-x-2 text-gray-700">
              <span className="text-sm font-medium">© 2024 Team Xerox</span>
